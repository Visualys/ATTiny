...
def trace(points):
    ...
    for pt in points:
        ...
        if len(pts)==1:
            ...
            print("G0 X%f Y%f" % (p[0], p[1]))
            print("G1 Z0 F100")
            print("G3 X%f Y%f I%f J%f" % (p[0], p[1], c[0], c[1]) )
            print("G0 Z10")
        else:
    ...
    for pts in points:
        for n in range(len(pts)):
            if n==0 or n==len(pts)-1:
                print("G0 X%f Y%f" % (pts[n][0]*unit, pts[n][1]*unit))
                print("G0 Z1")
                print("G1 Z-1 F150")
                print("G0 Z10")
    print("G0 X0Y0")
...
def detoure(pts):
    ...
    for n in range(len(pts)):
        if n==0:
            ...
            print("G1 X%f Y%f F100" % (pts[n][0]*unit, pts[n][1]*unit))
    print("G0 Z10")
    print("G0 X0Y0")
